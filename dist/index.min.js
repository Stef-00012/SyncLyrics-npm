...
v,w,z;if(!a||!g)return null;var x=Number.parseFloat(a.length)/1E3;x=`https://apic-desktop.musixmatch.com/ws/1.1/track.search?${new URLSearchParams({app_id:"web-desktop-app-v1.0",usertoken:g.usertoken,q_track:a.track||"",q_artist:a.artist||"",q_album:a.album||"",page_size:20,page:1,q_duration:x||"",s_track_rating:"asc"})}`;try{this.debugLog("Musixmatch search fetch URL:",x);const A=yield fetch(x,{headers:{cookie:g.cookies}});if(!A.ok)return this.warnLog(`Lyrics fetch request failed with status ${A.status} (${A.statusText}) [Musixmatch - Search]`),
...
c.source),(null===c||void 0===c?0:c.wordSynced)&&!e.wordSynced.lyrics&&(e.wordSynced.lyrics=c.wordSynced,e.wordSynced.source=c.source)}else this.infoLog(`The source "${f}" doesn't exist, skipping...`)}this._fetching=!1;return e})}getLyrics(a,g){return __awaiter(this,void 0,void 0,function*(){if(!((null===a||void 0===a?0:a.track)||(null===a||void 0===a?0:a.artist)||(null===a||void 0===a?0:a.album)||(null===a||void 0===a?0:a.trackId)))throw Error("SyncLyrics (getlyrics): At least one of track, artist, album or trackId must be present");
