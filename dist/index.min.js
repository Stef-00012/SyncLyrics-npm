...
this.infoLog=this.infoLog.bind(this);this.warnLog=this.warnLog.bind(this)}getMusixmatchUsertoken(a){return __awaiter(this,void 0,void 0,function*(){var g,d,b,c,e,f;this.infoLog("Getting Musixmatch token...");if(!this.saveMusixmatchToken||!this.getMusixmatchToken)return this.infoLog("Musixmatch token functions are not avaible, skipping..."),null;const k=yield this.getMusixmatchToken();if(k)return k;this.infoLog("Fetching the token from the API...");try{const m=yield fetch("https://apic-desktop.musixmatch.com/ws/1.1/token.get?user_language=en&app_id=web-desktop-app-v1.0",
{redirect:"manual",headers:{cookie:a}});if(301===m.status){this.debugLog("Successfully received the 'set-cookie' redirect response");const h=m.headers.getSetCookie().map(q=>q.split(";").shift()).filter(q=>"unknown"!==q.split("=").pop()).join("; ");this.debugLog("Re-fetching with the cookies...");return yield this.getMusixmatchUsertoken(h)}if(!m.ok)return this.warnLog(`The usertoken API request failed with the status ${m.status} (${m.statusText})`),null;const n=yield m.json();if(401===(null===(d=null===
...
n.message)||void 0===e?void 0:e.body)||void 0===f?void 0:f.user_token;if(!p)return this.infoLog("The API response did not include the usertoken"),null;const l={cookies:a,usertoken:p,expiresAt:(new Date(Date.now()+6E5)).getTime()};yield this.saveMusixmatchToken(l);this.infoLog("Successfully fetched the usertoken");return l}catch(m){}})}_searchLyricsMusixmatch(a,g){return __awaiter(this,void 0,void 0,function*(){var d,b,c,e,f,k,m,n,p,l,h,q,y,r,v,w,z;if(!a||!g)return null;var x=Number.parseFloat(a.length)/
...
void 0===f?void 0:f.body)||void 0===k?void 0:k.track_list);if(0>=(null===(p=null===(n=null===(m=null===u||void 0===u?void 0:u.message)||void 0===m?void 0:m.body)||void 0===n?void 0:n.track_list)||void 0===p?void 0:p.length))return this.infoLog("No songs were found [Musixmatch - Search]"),null;const t=null===(q=null===(h=null===(l=null===u||void 0===u?void 0:u.message)||void 0===l?void 0:l.body)||void 0===h?void 0:h.track_list)||void 0===q?void 0:q.find(F=>{var B,C,D,E;return(null===(B=F.track.track_name)||
...
"i");for(let e=0;e<a.length;e++){var b=a[e].match(/(\[.*?\])|([^\[\]]+)/g);if(!b||1===b.length)continue;let f=-1;for(var c=0;c<b.length;c++)if(!b[c].endsWith("]")){f=c;break}c="";-1<f&&(c=b.splice(f,1)[0],c=c.charAt(0).toUpperCase()+normalize(c.slice(1)));b=b[0];d.test(c)||g.push(`${b} ${c||""}`)}return g.join("\n")}fetchLyricsLrclib(a){return __awaiter(this,void 0,void 0,function*(){var g,d;if(!a)return null;this.infoLog(`Fetching the lyrics for "${a.track}" from "${a.album}" from "${a.artist}" (${this._trackId}) [LRCLIB]`);
const b=new URLSearchParams({track_name:a.track,artist_name:a.artist,album_name:a.album,q:a.track});try{const c=yield fetch(`https://lrclib.net/api/search?${b}`,{headers:{"Lrclib-Client":"SyncLyrics (https://github.com/Stef-00012/SyncLyrics)","User-Agent":"SyncLyrics (https://github.com/Stef-00012/SyncLyrics)"}});if(!c.ok)return this.warnLog(`Lyrics fetch request failed with status ${c.status} (${c.statusText}) [LRCLIB]`),null;const e=yield c.json();this.debugLog("lrclib.net results:",e);const f=
e.find(k=>{var m,n,p,l;return(null===(m=k.artistName)||void 0===m?void 0:m.toLowerCase().includes(null===(n=a.artist)||void 0===n?void 0:n.toLowerCase()))&&(null===(p=k.trackName)||void 0===p?void 0:p.toLowerCase())===(null===(l=a.track)||void 0===l?void 0:l.toLowerCase())});this.debugLog("lrclib filtered track:",f);if(!f||(!f.syncedLyrics||0>=(null===(g=f.syncedLyrics)||void 0===g?void 0:g.length))&&(!f.plainLyrics||0>=(null===(d=f.plainLyrics)||void 0===d?void 0:d.length)))return this.infoLog("The fetched song does not have lyrics [LRCLIB]"),
null;this.infoLog("Successfully fetched and cached the lyrics [LRCLIB]");return{source:"lrclib.net",plain:null===f||void 0===f?void 0:f.plainLyrics,lineSynced:null===f||void 0===f?void 0:f.syncedLyrics,wordSynced:null}}catch(c){return this.errorLog("Something went wrong while fetching the lyrics [LRCLIB]",c),null}})}fetchLyricsMusixmatch(a){return __awaiter(this,void 0,void 0,function*(){if(!a)return null;var g=yield this.getMusixmatchUsertoken();this.debugLog("Musixmatch token data:",g);if(!g)return null;
this.infoLog(`Fetching the lyrics for "${a.track}" from "${a.album}" from "${a.artist}" (${this._trackId}) [Musixmatch]`);const d=yield this._searchLyricsMusixmatch(a,g);if(!d||!d.hasLyrics&&!d.hasLineSyncedLyrics&&!d.hasWordSyncedLyrics||!d.commonTrackId&&!d.trackId)return this.infoLog("Missing both commontrack_id and track_id [Musixmatch - Search]"),null;g=yield this._fetchLyricsMusixmatch(a,g,d.trackId,d.commonTrackId,d.hasLyrics,d.hasLineSyncedLyrics,d.hasWordSyncedLyrics);return Object.assign({source:"Musixmatch"},
g)})}fetchLyricsNetease(a){return __awaiter(this,void 0,void 0,function*(){if(!a)return null;const g=yield this._searchLyricsNetease(a);return g?{source:"Netease",lineSynced:yield this._fetchLyricsNetease(a,g),plain:null,wordSynced:null}:(this.infoLog("Missing track ID [Netease - Search]"),null)})}_getLyrics(a){return __awaiter(this,void 0,void 0,function*(){const g={musixmatch:["plain","line","word"],lrclib:["plain","line"],netease:["line"]},d={musixmatch:this.fetchLyricsMusixmatch,lrclib:this.fetchLyricsLrclib,
netease:this.fetchLyricsNetease};var b=this.sources||["musixmatch","lrclib","netease"];const c={plain:{source:null,lyrics:null},lineSynced:{source:null,lyrics:null},wordSynced:{source:null,lyrics:null}};b.every(e=>!Object.keys(d).includes(e))&&(b=["musixmatch","lrclib","netease"]);a:for(const e of b){this.infoLog(`Trying to fetch the lyrics from the source "${e}"`);if(!("musixmatch"!==e||this.saveMusixmatchToken&&this.getMusixmatchToken)){this.infoLog("Musixmatch token functions are not avaible, skipping...");
continue}b=0;const f=g[e];for(const k of f)if("plain"===k&&c.plain.lyrics&&b++,"line"===k&&c.lineSynced.lyrics&&b++,"word"===k&&c.wordSynced.lyrics&&b++,b>=f.length)continue a;if(Object.keys(d).includes(e)){if(b=yield d[e](a))(null===b||void 0===b?0:b.plain)&&!c.plain.lyrics&&(c.plain.lyrics=b.plain,c.plain.source=b.source),(null===b||void 0===b?0:b.lineSynced)&&!c.lineSynced.lyrics&&(c.lineSynced.lyrics=b.lineSynced,c.lineSynced.source=b.source),(null===b||void 0===b?0:b.wordSynced)&&!c.wordSynced.lyrics&&
(c.wordSynced.lyrics=b.wordSynced,c.wordSynced.source=b.source)}else this.infoLog(`The source "${e}" doesn't exist, skipping...`)}return c})}getLyrics(a,g){return __awaiter(this,void 0,void 0,function*(){if(!((null===a||void 0===a?0:a.track)||(null===a||void 0===a?0:a.artist)||(null===a||void 0===a?0:a.album)||(null===a||void 0===a?0:a.trackId)))throw Error("SyncLyrics (getlyrics): At least one of track, artist, album or trackId must be present");this._trackId=a.trackId||btoa(unescape(encodeURIComponent(`${a.track||
""}-${a.artist||""}-${a.album||""}`)));const d=g?null:this.cache.get(this._trackId),b=d||(yield this._getLyrics(a));!g&&(!this.cache.has(this._trackId)||(null===b||void 0===b?0:b.plain.lyrics)&&(null===d||void 0===d||!d.plain.lyrics)||(null===b||void 0===b?0:b.lineSynced.lyrics)&&(null===d||void 0===d||!d.lineSynced.lyrics)||(null===b||void 0===b?0:b.wordSynced.lyrics)&&(null===d||void 0===d||!d.wordSynced.lyrics))&&this.cache.set(this._trackId,b||{plain:{lyrics:null,source:null},lineSynced:{lyrics:null,
source:null},wordSynced:{lyrics:null,source:null}});if(!b)return{trackId:this._trackId,lyrics:{plain:{lyrics:null,source:null},lineSynced:{lyrics:null,source:null,parse:this.parseLyrics},wordSynced:{lyrics:null,source:null}},track:a.track,artist:a.artist,album:a.album,cached:!1};this.lyrics=b.lineSynced.lyrics;return{trackId:this._trackId,lyrics:Object.assign(Object.assign({},b),{lineSynced:Object.assign(Object.assign({},b.lineSynced),{parse:this.parseLyrics})}),track:a.track,artist:a.artist,album:a.album,
cached:!!d}})}parseLyrics(a=this.lyrics){a=null===a||void 0===a?void 0:a.split("\n");if(!a)return null;const g=[];let d;for(const f in a){var b=a[f].split(" ");const k=b.shift().replace(/[\[\]]/g,"");b=b.join(" ");var c=k.split(":")[0],e=k.split(":")[1];c=60*Number.parseFloat(c)+Number.parseFloat(e);e=this.instrumentalLyricsIndicator||"\uf001 ";"0"===f&&3<c&&e&&g.push({time:0,text:e});0<b.length?(d=k,g.push({time:c,text:b})):e&&(!d||3<d-k)&&(d=k,g.push({time:c,text:e}))}return g}getTrackId(a){return a.trackId?
a.trackId:btoa(unescape(encodeURIComponent(`${a.track||""}-${a.artist||""}-${a.album||""}`)))}setLogLevel(a){if(!a)return this.logLevel="none",this;if(!Object.keys(logLevels).includes(a))throw Error(`SyncLyrics: logLevel must be one of "${Object.keys(logLevels).join('" | "')}"`);this.logLevel=a;return this}setInstrumentalLyricsIndicator(a){if(!a)return this.instrumentalLyricsIndicator="\uf001",this;if("string"!==typeof a)throw Error("SyncLyrics: instrumentalLyricsIndicator must be a string");this.instrumentalLyricsIndicator=
a;return this}setSources(a){if(!a)return this.sources=["musixmatch","lrclib","netease"],this;if(!Array.isArray(a)||0>=a.length)throw Error('SyncLyrics: sources must be an array with atleast one of "musixmatch" | "lrclib" | "netease"');this.sources=a;return this}setCache(a){if(!a)return this.cache=new Map,this;if("function"!==typeof a.get||"function"!==typeof a.set||"function"!==typeof a.has)throw Error("SyncLyrics: cache must have .get, .set and .has methods");this.cache=a;return this}setSaveMusixmatchToken(a){if("function"!==
typeof a)throw Error("SyncLyrics: saveMusixmatchToken must be a function");this.saveMusixmatchToken=a;return this}setGetMusixmatchToken(a){if("function"!==typeof a)throw Error("SyncLyrics: getMusixmatchToken must be a function");this.getMusixmatchToken=a;return this}warnLog(...a){(logLevels[this.logLevel]||0)<logLevels.warn||console.warn("\u001b[33;1mWARNING:\u001b[0m",...a)}debugLog(...a){(logLevels[this.logLevel]||0)<logLevels.debug||console.debug("\u001b[35;1mDEBUG:\u001b[0m",...a)}errorLog(...a){(logLevels[this.logLevel]||
0)<logLevels.debug||console.debug("\u001b[35;1mDEBUG:\u001b[0m",...a)}infoLog(...a){(logLevels[this.logLevel]||0)<logLevels.info||console.info("\u001b[34;1mINFO:\u001b[0m",...a)}}exports.SyncLyrics=SyncLyrics;
