...
a.trackId:btoa(unescape(encodeURIComponent(`${a.track||""}-${a.artist||""}-${a.album||""}`)))}setLogLevel(a){if(!a)return this.logLevel="none",this;if(!Object.keys(a).includes(a))throw Error(`SyncLyrics: logLevel must be one of "${Object.keys(a).join('" | "')}"`);this.logLevel=a;return this}setInstrumentalLyricsIndicator(a){if(!a)return this.instrumentalLyricsIndicator="\uf001",this;if("string"!==typeof a)throw Error("SyncLyrics: instrumentalLyricsIndicator must be a string");this.instrumentalLyricsIndicator=
