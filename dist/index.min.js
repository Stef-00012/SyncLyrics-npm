...
this._trackId=this.lyrics=null;this._fetchLineSyncedLyricsMusixmatch=this._fetchLineSyncedLyricsMusixmatch.bind(this);this._fetchWordSyncedLyricsMusixmatch=this._fetchWordSyncedLyricsMusixmatch.bind(this);this._fetchPlainLyricsMusixmatch=this._fetchPlainLyricsMusixmatch.bind(this);this._searchLyricsMusixmatch=this._searchLyricsMusixmatch.bind(this);this._fetchLyricsMusixmatch=this._fetchLyricsMusixmatch.bind(this);this.getMusixmatchUsertoken=this.getMusixmatchUsertoken.bind(this);this.fetchLyricsMusixmatch=
this.fetchLyricsMusixmatch.bind(this);this._searchLyricsNetease=this._searchLyricsNetease.bind(this);this._parseNeteaseLyrics=this._parseNeteaseLyrics.bind(this);this._fetchLyricsNetease=this._fetchLyricsNetease.bind(this);this.fetchLyricsNetease=this.fetchLyricsNetease.bind(this);this.fetchLyricsLrclib=this.fetchLyricsLrclib.bind(this);this.parseLyrics=this.parseLyrics.bind(this);this._getLyrics=this._getLyrics.bind(this);this.getTrackId=this.getTrackId.bind(this);this.getLyrics=this.getLyrics.bind(this);
...
a.trackId:btoa(unescape(encodeURIComponent(`${a.track||""}-${a.artist||""}-${a.album||""}`)))}warnLog(...a){(logLevels[this.logLevel]||0)<logLevels.warn||console.warn("\u001b[33;1mWARNING:\u001b[0m",...a)}debugLog(...a){(logLevels[this.logLevel]||0)<logLevels.debug||console.debug("\u001b[35;1mDEBUG:\u001b[0m",...a)}errorLog(...a){(logLevels[this.logLevel]||0)<logLevels.debug||console.debug("\u001b[35;1mDEBUG:\u001b[0m",...a)}infoLog(...a){(logLevels[this.logLevel]||0)<logLevels.info||console.info("\u001b[34;1mINFO:\u001b[0m",
...a)}}exports.SyncLyrics=SyncLyrics;function normalize(a){return a.replace(/\uff08/g,"(").replace(/\uff09/g,")").replace(/\u3010/g,"[").replace(/\u3011/g,"]").replace(/\u3002/g,". ").replace(/\uff1b/g,"; ").replace(/\uff1a/g,": ").replace(/\uff1f/g,"? ").replace(/\uff01/g,"! ").replace(/\u3001|\uff0c/g,", ").replace(/\u2018|\u2019|\u2032|\uff07/g,"'").replace(/\u201c|\u201d/g,'"').replace(/\u301c/g,"~").replace(/\u00b7|\u30fb/g,"\u2022").replace(/\s+/g," ").trim()};
